...
- (id)init{
    ...
    self.modalBackgroundColor = [UIColor colorWithWhite:0 alpha:1];
...
- (void)showWithContentView:(UIView *)contentView andAnimated:(BOOL)animated{
    ...
    containerViewRect.origin.y -=_Up;  //背景上移
    ...
    contentView.frame = (CGRect){padding, padding, contentView.bounds.size};   //padding-50  可上移
